...
const materialList = ref([
  { id: 1, name: 'product_video_2024.mp4', type: 'VIDEO', materialTypePath: ['VIDEO', 'VIDEO_TALK'], format: '横版视频', size: '150MB', thumbnail: 'https://picsum.photos/id/1015/300/400', videoUrl: 'http://localhost:3000/1.mp4', industry: '电商', platform: '抖音', tags: '热销产品', uploader: '张三', clicks: 1234, exposure: 5678, consumption: '¥1,234', clickRate: 3.42, avgClickPrice: 0.98, avgThousandCost: 33.5, conversion: '2.1%', deepConversion: '0.8%', uploadTime: '2024-01-15 10:30', status: 'PASSED', author: '李明', operator: '王芳', photographer: '张伟', demandId: 'DEMAND_001', internalMaterialId: 'MAT_1001', editor: '孙磊', director: '李明', actor: ['王梅'], accountId: 'ACC_20001', nonGrantCost: 1000, platformMaterialId: 'PLT_780001', deliveryId: 'AD_900001', resolution: '720×1280', duration: '00:03:44', views: 0, price: 0, usage: '未使用', auditResult: 'PASS', auditSuggestion: '' },
